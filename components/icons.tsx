...
export const QrCodeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h18v18H3z" transform="scale(.5) translate(12 12)" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.5 9.5h5v5h-5z" transform="scale(.5) translate(12 12)" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h4v4H3z M17 3h4v4h-4z M3 17h4v4H3z M17 17h4v4h-4z" />
  </svg>
);
...
export const UserPlusIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" transform="translate(8, 0)" />
  </svg>
);
